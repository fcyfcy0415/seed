...
@WebServlet("/visitorcompany")
public class visitorcompany extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    {                                                                   // 鍔犺浇椹卞姩绋嬪簭  
	      ...
	      ResultSet rs = conn.prepareStatement("select into user (username) values ()").executeQuery();//鏌ヨ
