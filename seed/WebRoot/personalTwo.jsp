...
<body onload="onload()">
  <table cellspacing=10px>
       <tr>
         ...
         <th align="right"><div><a href="http://112.74.160.130:8080/seed/index.html?str=http://112.74.160.130:8080/seed/personal.jsp" type="button"  id="" onclick="" > <input class="button3" type="button" class="" value="关于我们"></a></div></th>
   ...
   <div class="text0">
     ...
     <div class="text1">
            ...
            <div>
             ...
             <span style="font-family:LiSu;font-size:30.0pt;">如果您没有填写个人简历请到我的简历页面填写个人简历</span></p>
            </div>
       
        <div class="text2">
          
          
<form action="personalThree" method="get" class="elegant-aero">
	<h1 class="h1">个人简历
	...
	<h5 class="h4">
		...
		<label class="label">
			 <input type="submit" name="health"   class="button" id="btn_register" onclick="" value="提交">
