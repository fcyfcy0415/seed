...
<body onload="onload()">
  <table cellspacing=10px>
       <tr>
         ...
         <th align="right"><div><a href="http://112.74.160.130:8080/seed/index.jsp?str=http://112.74.160.130:8080/seed/com.jsp" type="button" id="btn_register" onclick="" ><input class="button3"type="button" class="" value="关于我们"></a></div></th>
       </tr>
   </table>
   <div class="text0">
   </div>
  ...
  <div class="text2">   
   <form action="shanchu" method="post" class="elegant-aero">
	<h1 class="h1">个人简历
		...
		<label class="label">          
			...
			<input class="input[type=text]"  id="RName" type="text" name="RName" 
		...
		<label class="label">
			...
			<select class="select" name="sex">
			  <option value="<% out.print(resum.getRSex()); %>"><% out.print(resum.getRSex()); %></option>
			</select>
		</label>
	...
	<h5 class="h4">
		...
		<label class="label">
			...
			<input class="button" type="submit" class="button" value="删除信息" />
			<input type="hidden" name="Sno" value="<% out.print(request.getAttribute("sno")); %>">
