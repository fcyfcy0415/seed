...
<base href="<%=basePath%>">
	...
	-->
<link href="http://112.74.160.130:8080/seed/manPerCom.css" rel="stylesheet" type="text/css" />
...
<body bgcolor="#DDDDDD">
   ...
   <div class="text0">
      ...
      <form action="manPerCom" method="post"> 
   <div class="text1">
            ...
            <!-- 职位描述 end -->
               ...
               <div class="text4">
                <div>
                  <a href="http://112.74.160.130:8080/seed/manComIn.jsp"><input type="button"  class="btn_style" id="btn_login"    onclick="login()" value="企业信息"></a>
                  <a href="http://112.74.160.130:8080/seed/manPerIn.jsp"><input type="button"  class="btn_style" id="btn_login"    onclick="login()" value="用户信息"></a>
                <input type="button"   class="btn_style" id="btn_login"    onclick="login()" value="删除招聘信息">
                
                <input type="button"   class="btn_style" id="btn_login"    onclick="login()" value="删除举报信息">
